            ...
            <div class="content">
              <div class="logo"><a href="/"><img className="gfg-logo" src={logo} alt="logo"></img></a></div>
                  <ul class="menu-list"> 
                     ...
                     <li><a href="#about" className = "nav_event list-item">About </a></li>
                     <li><a href="#companies" className = "nav_projects list-item">Companies </a></li>
                     <li><a href="#contact" className= "nav_about list-item">Contact </a></li>
                     {/* <li>/></li> */}
                     <Toggle />
